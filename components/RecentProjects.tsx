        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[25vh]">
                ...
                <Image
                  ...
                  width={432}
                  height={432}
                  className="z-10 absolute -bottom-4 w-[18rem] sm:w-[27rem]"
                />
              </div>
